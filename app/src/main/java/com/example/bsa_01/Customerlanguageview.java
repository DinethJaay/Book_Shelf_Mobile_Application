...
public class Customerlanguageview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = FirebaseDatabase.getInstance().getReference("Books/Language");
        ...
        Backtodashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Customerlanguageview.this, Customer_Home.class);
