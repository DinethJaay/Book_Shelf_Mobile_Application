...
public class Customerhistorybooks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = FirebaseDatabase.getInstance().getReference("Books/History");
        ...
        Backtodashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Customerhistorybooks.this, Customer_Home.class);
