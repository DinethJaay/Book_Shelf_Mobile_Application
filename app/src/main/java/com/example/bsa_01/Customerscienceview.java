...
public class Customerscienceview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = FirebaseDatabase.getInstance().getReference("Books/Science");
        ...
        Backtodashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Customerscienceview.this, Customer_Home.class);
